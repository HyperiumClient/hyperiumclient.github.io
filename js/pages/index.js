(function() {
  ...
  const sumContributions = function(contributors) {
    return contributors
  ...
  fetchJson(CONTRIBUTORS_URL, function(data, error) {
    ...
    contributors.forEach(function(contributor) {
      ...
      element.innerHTML =
        '<div class="mdc-card"><div class="mdc-card__media mdc-card__media--square"' +
        "style=\"background-image: url('" +
        contributor.avatarUrl +
        "');\"" +
        '></div><div class="hyperium-card__primary">' +
